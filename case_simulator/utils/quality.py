...
def gen_quality() -> float:
    ...
    # Increase alpha/beta ratio from 8/2 (0.8) to 17/3 (0.85) to shift the mean.

    # Базовое распределение: бета с средним ~0.85 (альфа/(альфа+бета) = 17/(17+3) = 0.85)
    # Увеличьте соотношение альфа/бета с 8/2 (0.8) до 17/3 (0.85), чтобы сместить среднее значение.
